package guru.springframework.springjms.web.controller.v2;

import guru.springframework.springjms.web.model.v2.BeerDtoV2;
import guru.springframework.springjms.web.services.v2.BeerServiceV2;
...
public class BeerControllerV2 {
    ...
    public  ResponseEntity handlePost(@RequestBody BeerDtoV2 beer){
        BeerDtoV2 savedDto = beerService.saveNewBeer(beer);
